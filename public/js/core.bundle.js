...
(function(){
  ...
  function boot(){
    ...
    if(page==='home'){
      var gl = document.querySelector('.amm-globe');
      if(gl && window.__initStratGlobe){
        var goGlobe = function(){ try{ window.__initStratGlobe(gl); }catch(e){} };
        if('IntersectionObserver' in window){
          var gio = new IntersectionObserver(function(es){
            es.forEach(function(en){ if(en.isIntersecting){ gio.disconnect(); goGlobe(); } });
